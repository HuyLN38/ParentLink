...
import 'package:parent_link/pages/profile/legal/legal_page.dart';
import 'package:parent_link/pages/profile/legal/legal_content.dart';
                      ...
                      child: Column(
                        children: [
                          ...
                          _settingItem(
                              ...
                              Icon(Icons.add,
                                  size: 25, color: Apptheme.colors.gray)),
                          const SizedBox(height: 22),
                          _settingItemOnOff("Push notification", isPushNotif,
                              (value) {
                            setState(() {
                              isPushNotif = value;
                            });
                          ...
                          const SizedBox(height: 22),
                          _settingItemOnOff("Data save mode", isDataSave,
                              (value) {
                            setState(() {
                              isDataSave = value;
                            });
...
// Setting item
  ...
  Widget _settingItemOnOff(
      String text, bool isSwitched, ValueChanged<bool> onChanged) {
    return SizedBox(
        width: double.infinity,
        child: ElevatedButton(
          onPressed: () {
